                                ...
                                <form method="POST" action="{{ route('contact.us.store') }}" id="contactUSForm">
                                    ...
                                    <div class="grid gap-4">
                                        <div class="contact-subject">
                                            <label for="hs-subject-contacts-1" class="sr-only">subject</label>
                                            <input type="subject" name="subject" id="hs-subject-contacts-1" autocomplete="email" class="border py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="subject">
                                        </div>
