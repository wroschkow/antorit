<header class="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 dark:bg-gray-800">
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-semibold dark:text-white" href="{{URL::to('/')}}" > <div class="logo"></div></a>
            <div class="sm:hidden">
        ...
        <div id="navbar-collapse-basic" class="hidden basis-full grow sm:block">
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                <a class="font-medium text-blue-500"  href="{{URL::to('/')}}" aria-current="page">Home</a>
                <a class="font-medium text-blue-500"  href="{{URL::to('/#about')}}" aria-current="page">Über uns</a>
                <a class="font-medium text-blue-500"  href="{{URL::to('/kontakt')}}" aria-current="page">Kontakt</a>
            </div>
        </div>
    </nav>
</header>
